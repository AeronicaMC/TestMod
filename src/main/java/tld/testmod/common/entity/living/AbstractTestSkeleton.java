...
import tld.testmod.common.entity.living.ai.EntityAIAttackRangedBow;

public abstract class AbstractTestSkeleton extends EntityMob implements IRangedAttackMob
{
    private static final DataParameter<Boolean> SWINGING_ARMS = EntityDataManager.<Boolean>createKey(AbstractTestSkeleton.class, DataSerializers.BOOLEAN);
    ...
    private final EntityAIAttackMelee aiAttackOnCollide = new EntityAIAttackMelee(this, 1.2D, false)
    {
        ...
        {
            super.resetTask();
            AbstractTestSkeleton.this.setSwingingArms(false);
        }
        /**
        ...
        public void startExecuting()
        {
            ...
            AbstractTestSkeleton.this.setSwingingArms(true);
        }
    };

    public AbstractTestSkeleton(World worldIn)
    {
        super(worldIn);
