...
{
    private final AbstractTestSkeleton entity;
    ...
    public EntityAIAttackRangedBow(AbstractTestSkeleton skeleton, double speedAmplifier, int delay, float maxDistance)
    {
